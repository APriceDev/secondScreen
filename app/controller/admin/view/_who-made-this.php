        ...
        <div class="form-wrap">
            <form method="post" action="/admin/edit-event-options" class="form-horizontal" id="options-form">
                <fieldset>
                    ...
                    <div class="control-group">
                        <label class="control-label" for="character"><span class="color-red">*</span>&nbsp;Character</label>
                        <div class="controls">
                            <input type="text" class="input-large" name="character" id="character" value="<?php echo $this->escape(App_Model_EventOptions::getByKey($this->options, 'character'));?>"/>
                            <p class="muted">e.g. Alejandro Garcia</p>
                        </div>
                    </div>
