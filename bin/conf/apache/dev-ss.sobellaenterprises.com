<VirtualHost *:80>
        ...
        ServerName dev-ss.sobellaenterprises.com
        DocumentRoot /var/www/dev-ss.sobellaenterprises.com/public/
        ...
        <Directory />
                AuthType Basic
                AuthName "Access for dev-ss.sobellaenterprises.com"
        ...
        ErrorLog /var/log/apache2/dev-ss.sobellaenterprises.com-error.log

        # Possible values include: debug, info, notice, warn, error, crit,
        # alert, emerg.
        LogLevel warn

        CustomLog /var/log/apache2/dev-ss.sobellaenterprises.com-access.log combined
