<VirtualHost *:80>
        ...
        ServerName fe-ss.sobellaenterprises.com
        DocumentRoot /var/www/fe-ss.sobellaenterprises.com/public/
        ...
        <Directory />
                AuthType Basic
                AuthName "Access for fe-ss.sobellaenterprises.com"
        ...
        ErrorLog /var/log/apache2/fe-ss.sobellaenterprises.com-error.log

        # Possible values include: debug, info, notice, warn, error, crit,
        # alert, emerg.
        LogLevel warn

        CustomLog /var/log/apache2/fe-ss.sobellaenterprises.com-access.log combined
