...
require_once "$system/core/solarlite.php";
...
$solarlite::$system = $system;
        
// register autoloader
spl_autoload_register(array($solarlite, 'autoload'));

// disable memcache?
if (isset($disable_memcache) && $disable_memcache) {
    $config['database']['cache'] = null;
}
...
// Define Sobella constants
define('SS_ENV', $config['ENV']);
define('SS_DEBUG', $config['DEBUG']);
if (!defined('HOST_NAME')) {
    if (isset($_SERVER['HTTP_HOST'])) {
        define('HOST_NAME', $_SERVER['HTTP_HOST']);
    } else {
        define('HOST_NAME', 'ss.sobellaenterprises.com');
    }
}
...
if (!defined('BASE_URL')) {
    if (isset($_SERVER['HTTP_HOST'])) {
        ...
        define('BASE_URL', $protocol . 'ss.sobellaenterprises.com');
    }
}
